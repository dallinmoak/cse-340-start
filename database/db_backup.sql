...
create table
  course_340.review (
    ...
    constraint review_account_fk foreign key (author_id) references course_340.account (account_id),
    constraint review_inventory_fk foreign key (inv_id) references course_340.inventory (inv_id)
  );
